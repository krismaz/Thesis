...
${OBJECTDIR}/src/AnnealingSort.o: src/AnnealingSort.cpp 
	...
	$(COMPILE.cc) -g -o ${OBJECTDIR}/src/AnnealingSort.o src/AnnealingSort.cpp

${OBJECTDIR}/src/CUDA.o: src/CUDA.cu 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -g -o ${OBJECTDIR}/src/CUDA.o src/CUDA.cu

${OBJECTDIR}/src/Comparables.o: src/Comparables.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -g -o ${OBJECTDIR}/src/Comparables.o src/Comparables.cpp

${OBJECTDIR}/src/RandShellSort.o: src/RandShellSort.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -g -o ${OBJECTDIR}/src/RandShellSort.o src/RandShellSort.cpp

${OBJECTDIR}/src/Shellsorts.o: src/Shellsorts.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -g -o ${OBJECTDIR}/src/Shellsorts.o src/Shellsorts.cpp

${OBJECTDIR}/src/SortingNetworks.o: src/SortingNetworks.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -g -o ${OBJECTDIR}/src/SortingNetworks.o src/SortingNetworks.cpp
